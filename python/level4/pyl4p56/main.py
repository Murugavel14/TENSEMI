class Node: #node class, this class for one student
    def _init_(self,ide,mat,sci):#self is current object. constructor (runs automatically when object is created).id,mat,sci are input values
...
llist=LinkedList() #linked list object, automatically calls _init()_(self)
