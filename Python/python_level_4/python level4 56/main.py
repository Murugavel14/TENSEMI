...
class LinkedList: #class it manage entire list, this class for manage all students
    ...
    def insert(self,ide,mat,sci): #add new student to the list
        new_node=Node(ide,mat,sci) #new Node, it create one student list in one objectx
...
while True:#infinite loop to take input
    ...
    llist.insert(ide,mat,sci) #for to add student
